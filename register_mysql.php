...
<body>
    <div class="flex-container">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <div class="input-boxes" <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
                <label>Username:<sup>*</sup></label>
                <input type="text" name="username" value="<?php echo $username; ?>">
                <span class="reg-err"><?php echo $username_err; ?></span>
            </div>    
            <div class="input-boxes" <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
                <label>Password:<sup>*</sup></label>
                <input type="password" name="password" value="<?php echo $password; ?>">
                <span class="reg-err"><?php echo $password_err; ?></span>
            </div>
            <div class="input-boxes" <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>">
                <label>Confirm Password:<sup>*</sup></label>
                <input type="password" name="confirm_password" value="<?php echo $confirm_password; ?>">
                <span class="reg-err"><?php echo $confirm_password_err; ?></span>
            </div>
            <div id="sub-button">
